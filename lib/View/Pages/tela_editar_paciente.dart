...
class _TelaEditarPacienteState extends State<TelaEditarPaciente> {
  ...
  Future<void> _carregarPaciente() async {
    ...
    try {
      ...
      setState(
        () => _erro = "Não foi possível carregar os dados do paciente.",
      );
    } finally {
  ...
  void _preencherFormulario(PacienteDetalheModel paciente) {
    ...
    _generoSelecionado =
        _generos.contains(paciente.genero) ? paciente.genero : null;
    ...
    if (endereco != null) {
      ...
      _estadoSelecionado =
          _estados.contains(endereco.estado) ? endereco.estado : null;
    }
  }
